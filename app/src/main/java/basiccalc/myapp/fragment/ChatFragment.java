...
import basiccalc.myapp.adapter.CustomAdapter;
...
public class ChatFragment extends Fragment {
    ...
    String [] judul = {"Muhammad Habibullayev","Valixon Yuldashov","Sapoboy Sapoyev"};
    String [] deskripsi = {"nichiksan ey paqa paq","Valixon IOS chi","Xivali bratishkalara salom"};
